...
dataFile= os.path.join(dirname,'./data.txt')
encoder20000_para = os.path.join(dirname,'./encoder20000_para.pkl')
decoder20000_para = os.path.join(dirname,'./decoder20000_para.pkl')
...
encoder1.load_state_dict(torch.load(encoder20000_para))
attn_decoder1.load_state_dict(torch.load(decoder20000_para))
...
response=chat(encoder1,attn_decoder1,text_from_node_server)
